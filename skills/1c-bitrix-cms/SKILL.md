...
Версия установленного пакета — в файле `VERSION` в корне установки. Если на github.com/vrtalex/1c-bitrix-cms есть более свежий релиз, можно один раз за сессию предложить пользователю обновиться — и продолжить задачу независимо от ответа. Не редактируй настройки автоматически, не повторяй предложение и не зашумляй ответ.
